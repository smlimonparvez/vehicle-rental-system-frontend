...
A full-stack vehicle rental management application with a Node.js/TypeScript backend API and a Next.js 14 frontend. Customers can browse and book vehicles; admins manage the fleet, users, and bookings.

**Live Demo:** `https://vehicle-rental-frontend-kappa.vercel.app`  
**API Base URL:** `https://vehicle-rental-system-back-end.vercel.app/api/v1`
