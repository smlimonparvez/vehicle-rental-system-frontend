  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-blue-600 to-indigo-700 py-24 text-center px-6">
        <span className="inline-block bg-white/20 text-white text-sm font-medium px-4 py-1.5 rounded-full mb-4 border border-white/30">
          About VehicleRental
        </span>
        ...
        <p className="text-blue-100 max-w-xl mx-auto text-lg">
          We are a team passionate about making vehicle rental effortless, fair, and accessible for everyone.
        </p>
      </section>
      ...
      <section className="py-20 bg-white dark:bg-gray-950">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 leading-relaxed mb-4">
            VehicleRental was founded with a simple idea: renting a vehicle should be as easy as booking a table at a restaurant. No phone calls, no paperwork — just a few clicks and you are on your way.
          </p>
          <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
            Since 2019, we have grown from a small fleet of 20 cars to over 500 vehicles across 50 cities. We remain committed to our founding principle of transparent, fair, and flexible rentals.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {TEAM.map(({ name, role, initial, color }) => (
              <div key={name} className="group relative bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center">
                  <div className={`w-20 h-20 rounded-2xl ${color} flex items-center justify-center text-3xl font-bold text-white mx-auto mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                    {initial}
                  </div>
                  <p className="font-bold text-gray-900 dark:text-white text-center text-lg">{name}</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 font-medium">{role}</p>
                </div>
              </div>
            ))}
          </div>
